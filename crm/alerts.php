...
<!-- 			<div class="col-sm-3" id="side_menu3">
			   <ul id="side_menu">
					<li><a href="#xx" onclick="showxx">Missing/Found Person List</a></li>
					<li><a href="#yy">Missing/Found Vehicles List</a></li>						
					<li><a href="#zz">Lost/Found Items List</a></li>
			  </ul>
		...
		<script type="text/javascript">
			function showxx(){
				document.getElementById('xx').style.display=1;
			}
