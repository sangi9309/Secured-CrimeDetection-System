            ...
            <div class="well" id="report_crime_display">
              <form class="bs-example form-horizontal" method="post" action="" id="report_crime" >
                ...
                <tr>
                    ...
                    <div class="col-lg-7">
                      <input class="form-control" id="crime_type" placeholder="Date" type="date" required name="date">
                    </div>
                  </div>
                </tr>
                <tr>
                  ...
                  <h3>Specify Location</h3>
                   <div class="form-group">
                    <label for="county" class="col-lg-2 control-label">State</label>
                    <div class="col-lg-7">
                       <input class="form-control" id="county" placeholder="State" type="text" required  name="county">
                    </div>
                  </div>
                </tr>
                <tr>
                  <div class="form-group">
                    <label for="category" class="col-lg-2 control-label">City</label>
                    <div class="col-lg-7">
                       <input class="form-control" id="sub_county" placeholder="City" type="text"  required name="sub_county">
                    </div>
                  </div></tr>
				  <tr>
                  <div class="form-group">
                    <label for="street" class="col-lg-2 control-label">Area</label>
                    <div class="col-lg-7">
                      <input class="form-control" id="street" placeholder="Area" type="text"  required name="street">
