           ...
           <div class="col-md-12">
                   <div class="dashboard-content">
                     <div class="dashboard-heading">Info</div>
                     	<p style="margin-top:20px;background-color:#ccf6ae; border:2px solid #b1f580; padding:10px 15px;border-radius:5px;">Success! Report Deleted Successfully. <a href="index.php">Back to home</a></p>
                    </div>
           </div>
