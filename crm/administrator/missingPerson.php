           ...
           <div class="col-md-12">
                   <div class="dashboard-content">
					...
					?>
						<tr>
                      	<td colspan="2">
                      		<?php 
                      			if(!isset($_GET['status'])){
                      		?>
                          <input style="border:none; margin-top: 10px; margin-right:20px;" type="submit" class="btn-danger btn-sm pull-right" name="personFound" value="Delete Report" />
                      ...
                      </tr><tr><td><input style="border:none; margin-top: 10px;margin-right:20px;" type="submit" class="btn-success btn-sm pull-right" name="deny" value="Cancel" />&nbsp; &nbsp;</td></tr>
                     </form>
					<?php
						}
						else{
