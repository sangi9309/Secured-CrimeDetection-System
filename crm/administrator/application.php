...
?>
  <div class="container">
    <div id="header">
        ...
        <div class="div2">
           <div class="logo"><img src="images/lg.jpg" width="60px" height="50px"/><span>Crime Report</span> System</div> <h3>| Admin Panel</h3>
        </div>
    </div>
           ...
           <div class="col-md-12">
                   <div class="dashboard-content">
					...
					?>
						<tr>
                      	<td colspan="2">
                      		<input style="border:none; margin-top: 10px;margin-right:20px;" type="submit" class="btn-success btn-sm pull-right" name="deny" value="Cancel" />&nbsp; &nbsp;
                      		<input style="border:none; margin-top: 10px; margin-right:20px;" type="submit" class="btn-danger btn-sm pull-right" name="grant" value="Delete" />
                      	</td>
                      </tr>
                     </form>
					<?php
